...
<div class="page-main-header">
    <div class="main-header-right row m-0">
        <div class="main-header-left">
            <div class="logo-wrapper"><a href="<?= Url::to(['/site/index/']) ?>"><img class="img-fluid"
                                                                        src="<?= Url::home() ?>images/logo/logo.png"
                                                                        alt=""></a></div>
            <div class="dark-logo-wrapper"><a href="<?= Url::to(['/site/index/']) ?>"><img class="img-fluid"
                                                                             src="<?= Url::home() ?>images/logo/dark-logo.png"
                                                                             alt=""></a></div>
        ...
        <div class="nav-right col pull-right right-menu p-0">
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown p-0">
                    ...
                    <?= Html::submitButton(
                        '<i data-feather="log-out"></i>' . Yii::t('app', 'Logout'),
